...
const hotels = [
  { id: 'b1', name: 'Ubud Hanging Gardens', stars: 5, price: 180, rating: 9.7, reviews: 2150, img: '/chrice-agency/assets/bali_1.jpg', desc: "Immergé dans la jungle tropicale, célèbre pour ses piscines à débordement suspendues.", amenities: ['Piscine cascade privée', 'Lit à baldaquin', 'Douche ciel ouvert'] },
  { id: 'b2', name: 'The Edge Uluwatu', stars: 5, price: 250, rating: 9.8, reviews: 1100, img: '/chrice-agency/assets/bali_2.jpg', desc: "Perché sur une falaise spectaculaire offrant une vue plongeante sur l'océan Indien.", amenities: ['Majordome attitré', 'Plancher de verre', 'Spa Cliff'] },
  { id: 'b3', name: 'Potato Head Suites', stars: 4, price: 120, rating: 9.3, reviews: 3400, img: '/chrice-agency/assets/bali_3.jpg', desc: "L'art de vivre éco-responsable et branché en plein cœur de Seminyak.", amenities: ['Bar cocktail en chambre', 'Accès direct Beach Club', 'Design éthique'] },
  { id: 'b4', name: 'Padma Resort Ubud', stars: 4, price: 95, rating: 9.6, reviews: 4800, img: '/chrice-agency/assets/bali_4.jpg', desc: "Un havre de paix familial avec la plus grande piscine chauffée de Bali.", amenities: ['Piscine 89 mètres', 'Club enfant inclus', 'Balcon panoramique'] }
];
  ...
  return (
    <div className="w-full">
      <div className="relative h-[60vh] overflow-hidden mb-16 shadow-2xl">
        <img src="/chrice-agency/assets/dl_asset_1781709139379_3.jpg" alt="Bali" className="w-full h-full object-cover brightness-50" />
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-8 mb-12 relative z-10">
        <LiveLocalStatus city="Bali" timezone="Asia/Makassar" weather="sun" temp={28} />
      </div>
