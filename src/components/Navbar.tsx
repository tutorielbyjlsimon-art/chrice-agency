      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-white">
          ...
          <div className="relative group">
            <button className="flex items-center gap-2 p-2 hover:text-brand-500 transition-colors rounded-full bg-white/5 font-bold text-sm">
              <Globe size={18} /> {state.currency}
            </button>
          ...
          <button onClick={() => setIsLight(!isLight)} className="p-2 hover:text-brand-500 transition-colors rounded-full bg-white/5 ml-2 mr-2" title="Basculer le thème">
            {isLight ? <Moon size={20} /> : <Sun size={20} />}
          </button>
          
          <span className="text-sm font-bold text-brand-500 hidden sm:block">Espace Premium</span>
          <button className="p-2 hover:text-brand-500 transition-colors rounded-full bg-white/5">
            <User size={20} />
          </button>
        </div>
      </div>
